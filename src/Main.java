...
public class Main extends JFrame{
	...
	public Main(){
		...
		for (int i = 0; i < carpetas.length; i++) {
			File archivoIndex = new File(route + "\\" + carpetas[i] + "\\index.html");
			File archivoForm = new File(route + "\\" + carpetas[i] + "\\form.html");
			...
			if(indexEncontrado){
				...
				System.out.println("No se ha encontrado el archivo index.html en la carpeta.");
				continue;
			}
		}
